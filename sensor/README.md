# /readme - indepth analysis of existing code on made for the proforge
...
The pixel to gcode global coordinates ratio is around 26.13 with the height its at. The few mm the camera moves up and down should not affect this significantly. 
